...
$ch = $db->Execute("SELECT * FROM $dbtables[chiefs] "
                  ."WHERE clanid = '$clanid'");
$chiefinfo = $ch->fields;

$res = $db->Execute("SELECT clanname FROM $dbtables[clans] "
                   ."WHERE clanid = '$clanid'");
$resclan = $res->fields;

$_SESSION['clanname'] = $resclan[clanname];

$restrib = $db->Execute("SELECT * FROM $dbtables[tribes] "
                       ."WHERE clanid = '$clanid' "
                       ."AND tribeid = '$_GET[id]'");
...
{
    $res2 = $db->Execute("SELECT * FROM $dbtables[tribes] "
                        ."WHERE tribeid = '$curr_unit' ");
