...
if (ISSET($_POST['dump']))
{
 ...
 //TODO- "Real Estate" sales- tribes can own structures at locations they arent *on*
 //structures stay in place, tribes move TO structures.
...
else
{
    ...
    $n = 0;
    foreach( $_POST['structure'] as $key => $bldg )
    {
        $rc = $n % 2;
