...
else
{
    ...
    $db->Execute("CREATE TABLE $dbtables[fair] ("
                ...
                .") TYPE=MyISAM");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bricks','bricks',2.00,6.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bread','bread',1.00,2.99,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Charcoal','charcoal',1.00,3.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Horses','horse',3.27,160.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Elephants','elephant',7.32,220.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Coke','coke',10.80,0.00,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Silver','silver',1.00,1.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Scrapers','scrapers',9.26,5.21,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Plate','ironplate',0.00,1015.61,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Buckler','ironbuckler',0.00,28.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Helm','ironhelm',12.00,20.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Bascinet','ironbascinet',0.00,78.12,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Greave','irongreaves',0.00,3681.84,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Cross Bow','crossbow',2.12,565.02,150,30,'N',150)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Repeating Arbalest','repeatingarbalest',0.00,4450.38,25,5,'N',25)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Silver Ore','silver.ore',1.72,1.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Pigs','pigs',1.00,57.27,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Sheep','sheep',2.04,31.75,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bladders','bladder',10.00,13.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Ladder','ladder',3.00,8.00,25,5,'N',25)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Catapult','catapult',0.00,220.00,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Stone Axe','stoneaxe',25.20,14.87,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Stone Spear','stonespear',15.00,25.00,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Cuirboilli','cuirboilli',52.00,112.50,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Mace','ironmace',3.00,10.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Long bow','longbow',1.00,1.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Clubs','clubs',1.00,2.00,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bricks','bricks',2.00,6.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bread','bread',1.00,2.99,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Charcoal','charcoal',1.00,3.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Horses','horse',3.27,160.00,200,40,'N',200)");
    ...
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Pigs','pigs',1.00,57.27,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Sheep','sheep',2.04,31.75,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Saddlebags','saddlebags',12.43,91.48,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Saddle','saddle',6.40,54.68,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Shackles','shackles',8.00,31.25,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Hoe','hoe',4.68,12.50,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Trumpets','trumpet',3.00,0.00,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Backpack','backpack',9.10,85.82,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Whip','whip',5.00,15.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bone Armor','bonearmor',0.00,150.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Hoods','hood',1.00,3.12,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Backpack','backpack',9.10,85.82,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Whip','whip',5.00,15.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Trews','trews',3.07,24.40,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Wooden Shield','woodenshield',0.00,80.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bone Axe','boneaxe',6.00,10.83,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bone Frame','boneframe',2.00,5.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Zinc','zinc',10.05,2.27,6000,1200,'N',6000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Zinc Ore','zinc.ore',1.98,1.44,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Slaves','slaves',8610.21,27.77,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Chain','ironchain',0.00,1424.11,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Horsebow','horsebow',26.00,780.78,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Ring Mail','ring',0.00,250.00,150,30,'N',150)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Strings','strings',1.32,3.25,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Spice','spice',135.39,0.00,400,80,'N',400)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Scythe','scythe',0.00,126.95,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Sugar','sugar',36.56,2.69,1000,200,'N',1000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Sword','Ironsword',80.41,194.85,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Tapestry','tapestry',1020.00,0.00,25,5,'N',25)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Tar','tar',1.00,0.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Tin','tin',5.00,7.00,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Tin Ore','tin.ore',3.61,2.28,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Tobacco','tobacco',1362.52,0.00,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Traps','traps',11.60,3.57,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Trinket','trinket',10.00,0.00,1000,200,'N',1000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Urn','urn',27.00,0.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Wagon','wagon',259.45,1.61,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Wax','wax',202.38,74.83,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Wine','wine',48318.14,0.00,150,30,'N',150)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Palanquin','palanquin',0.00,25.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Parchment','parchment',8.00,0.00,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Picks','picks',29.91,70.10,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Plow','plow',356.30,179.75,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Provisions','provs',33.51,1.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Rake','rake',18.41,0.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Rope','rope',27.22,32.15,400,80,'N',400)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Rug','rug',187.20,0.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Rum','rum',17972.49,0.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Salt','salt',2.26,1.10,7000,1400,'N',7000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Scutum','scutum',60.00,92.00,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Shaft','shaft',3.67,1.84,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Shovel','shovel',305.04,4.33,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Skins','skins',1.00,82.34,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Scale Armor','scale',0.00,181.25,175,35,'N',175)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Shield','ironshield',0.00,572.18,175,35,'N',175)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Sling','sling',5.83,8.33,1000,200,'N',1000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Snares','snares',10.00,22.50,2000,400,'N',2000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Spear','ironspear',46.91,62.33,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Spetum','spetum',20.00,35.00,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Staves','staves',7.63,1.84,1000,200,'N',1000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Stones','stones',3.85,1.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Jerkin','jerkin',4221.08,1.00,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Kayak','kayak',110.00,0.00,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Lead','lead',3.36,7.14,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Lead Ore','lead.ore',4.83,1.64,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Leather','leather',1.00,190.42,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Logs','logs',1.18,1.79,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Lutes','lutes',600.00,0.00,25,5,'N',25)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Mattock','mattock',70.00,0.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Mead','mead',846.02,0.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Net','net',21.12,31.25,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Ornament','ornament',25.00,0.00,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Harp','harp',600.00,0.00,25,5,'N',25)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Haube','haube',40.00,60.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Heaters','heaters',7.60,7.92,1000,200,'N',1000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Herbs','herbs',12.70,51.22,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Hives','hives',121.40,510.87,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Horn','horn',22.00,0.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Honey','honey',8.80,16.25,2000,400,'N',2000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Inlay','inlay',920.00,0.00,40,8,'N',40)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron','iron',16.13,8.20,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Ore','iron.ore',1.72,1.36,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Jar','jar',13.00,0.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Flutes','flutes',12.00,15.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Frames','frame',2.50,5.00,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Furs','furs',2.42,2.48,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Glass Pipe','glasspipe',2.00,0.00,750,150,'N',750)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Goats','goat',1.00,176.80,10000,2000,'N',10000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Gold','gold',1605.88,5.66,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Goldwork','goldwork',700.00,0.00,25,5,'N',25)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Grain','grain',1.72,0.00,15000,3000,'N',15000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Grapes','grapes',0.00,4.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Gut','gut',1.52,1.00,20000,4000,'N',20000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Coal','coal',426.56,1.00,15000,3000,'N',15000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Copper','copper',4.11,6.70,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Copper Ore','copper.ore',3.18,1.86,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Cotton','cotton',178.80,1.00,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Cauldron','cauldron',5.00,0.00,1250,250,'N',1250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Cuirass','cuirass',0.00,180.00,100,20,'N',100)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bone Cuirboilli','cuirboillibone',50.00,70.00,150,30,'N',150)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Dogs','dogs',115.40,418.82,150,30,'N',150)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Drums','drums',27.00,35.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Ewer','ewer',9.00,0.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Falchions','falchions',54.00,85.00,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Flutes','flutes',12.00,15.00,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Frames','frame',2.50,5.00,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Furs','furs',2.42,2.48,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Glass Pipe','glasspipe',2.00,0.00,750,150,'N',750)");
    ...
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Grain','grain',1.72,0.00,15000,3000,'N',15000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Grapes','grapes',0.00,4.00,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Flour','flour',3.00,0.00,10000,2000,'N',10000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bone Spear','bonespear',57.04,1.00,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bow','bow',250.14,5.38,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Brandy','brandy',3872.25,0.00,175,35,'N',175)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Breastplate','ironbreastplate',0.00,425.00,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Brass','brass',3.20,11.71,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bronze','bronze',18.75,31.25,2500,500,'N',2500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bronzestatue','bronzestatue',10000.00,0.00,5,1,'N',5)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Candles','candles',70.00,0.00,150,30,'N',150)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Cattle','cattle',1.00,1.00,500,100,'N',500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Carpet','carpet',2949.60,0.00,60,12,'N',60)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Cloth','cloth',234.00,156.25,150,30,'N',150)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Adze','adze',65.00,0.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Ale','ale',1178.82,0.00,200,40,'N',200)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Arbalest','arbalest',0.00,1152.82,75,15,'N',75)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Iron Axe','ironaxe',58.88,149.45,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Ballistae','ballistae',250.00,400.00,50,10,'N',50)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bark','bark',0.00,1.01,5000,1000,'N',5000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Barrels','barrels',17.92,97.65,250,50,'N',250)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Beads','beads',4.00,0.00,1500,300,'N',1500)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Beaker','beaker',26.73,0.00,1000,200,'N',1000)");
    $db->Execute("INSERT INTO $dbtables[fair] VALUES ('','Bones','bones',65.45,1.00,25000,5000,'N',25000)");
    echo " Done!<BR>";
    flush();
...
$db->Execute("INSERT INTO $dbtables[skills] VALUES('','fctl','Fire Control','c','$tribeid','$fire_control','')");
    ...
    //echo "</FORM><BR>";
    echo "Set Up Complete. You must set a crontab to run every hour and point it to <a href='../scheduler.php'>YOUR SCHEDULER</a><br>";
    echo "Example:<strong> 0 * * * * wget -q -O - 'http://your-domain-here.com/freetribes/scheduler.php' >/dev/null</strong><br>";
