...
db_op_result($res,__LINE__,__FILE__);
//PICK ONE- both do the same thing.. truncate does delete plus reset pointer to 0
$res = $db->Execute("TRUNCATE table $dbtables[poptrans]");
db_op_result($res,__LINE__,__FILE__);
echo "optimize done in ".(time() - $curtime)." seconds <br>";
/////////////////////////////////Establish Game Time//////////////////////////////////////////
...
$res = $db->Execute("DELETE FROM $dbtables[last_turn]");
db_op_result($res,__LINE__,__FILE__);
//also PICK ONE.. see above- truncate = "delete and reset pointer"
$res = $db->Execute("TRUNCATE $dbtables[last_turn]");
db_op_result($res,__LINE__,__FILE__);
///////////////////////////////////Copy this turn's into last_turn//////////////////////////////
///////////////////////////Not including defaults added by the game////////////////////////////
echo "skills done in ".(time() - $curtime)." seconds <br>";
...
echo "leatherwork done in ".(time() - $curtime)." seconds <br>";
//////////////////////////////////////////////////Weaving///////////////////////////////////////////////////
include("weaving.php");
///////////////////////////////////////////////////Sewing/////////////////////////////////////////////////
include("sewing.php");
...
////////////////////////////////////////////////Seeking/////////////////////////////////////////////////////////////
include("seeking.php");
echo "seeking done in ".(time() - $curtime)." seconds <br>";
////////////////////////////////////////////Population///////////////////////////////////////////////////
...
echo "at diff done in ".(time() - $curtime)." seconds <br>";

$result = $db->Execute("INSERT INTO $dbtables[lorgs] "
            ."VALUES("
            ."'',"
            ."'$month[count]',"
            ."'$year[count]',"
...
var_dump($result);
            ...
            echo "EOF done in ".(time() - $curtime)." seconds <br>";
