...
{
	$month_flag=" (this month)";
	$last_month = $viewmonth - 1;
	if ($last_month < 1)
	{
		$last_month = 12;
	}
	$_REQUEST[month] = $viewmonth;
...
echo "<FORM ACTION=admin_tribe_report.php METHOD=POST>";
...
echo "<TR BGCOLOR=\"$color_header\">"
	...
	."<TD ALIGN=CENTER><B>System Logs</B> (Admin $playerinfo[chiefname])</TD>"
	."<TD></TD>"
	."</TR>";
echo "<TR BGCOLOR=\"$color_header\">"
...
echo "<TR BGCOLOR=\"$line_color\"><TD align=center>$newsinfo[tribeid]</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD NOWRAP>$newsinfo[time]</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>$newsinfo[type]</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD align=right>$newsinfo[month]</TD><TD align=center>/</TD><TD align=left>$newsinfo[year]</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD WIDTH=\"85%\">$newsinfo[data]</TD></TR>";
$result2->MoveNext();
